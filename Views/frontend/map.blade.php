    ...
    <div id="stream_modal"
        ...
        <div
            ...
            <div class="bg-black aspect-video flex items-center justify-center relative w-full overflow-hidden"
                ...
                <div
                    class="absolute bottom-[22px] left-3 sm:bottom-[26px] sm:left-4 z-20 bg-white/95 border border-slate-200 text-slate-800 font-mono-tech text-[8px] sm:text-[10px] tracking-wider px-2 py-0.5 sm:px-2.5 sm:py-1 pointer-events-none select-none shadow-sm rounded-md flex items-center space-x-1.5 sm:space-x-2">
                ...
                <div
                    class="hidden md:block absolute bottom-[26px] right-4 z-20 bg-white/95 border border-slate-200 text-slate-800 font-mono-tech text-[10px] tracking-wider px-2.5 py-1 pointer-events-none select-none shadow-sm rounded-md">
